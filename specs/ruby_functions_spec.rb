...
class FunctionsTest < MiniTest::Test
  ...
  def test_number_to_full_name__month_1()
    result = number_to_full_month_name( 10 )
    assert_equal( "October", result )
  end
  ...
  def test_volume_of_cube()
    volume_of_cube = volume_of_cube(10)
  ...
  assert_equal(268, volume_of_sphere)
  end
  #
  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celcius = fahrenheit_to_celcius(78)
    assert_equal(25, fahrenheit_to_celcius)
  end
